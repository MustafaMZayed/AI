...
# 2-Splitting the dataset into the two sets Training set and Test set
...
# 12-Fitting Decision Tree  to the Training set
...
# 14-Making the Confusion Matrix
from sklearn.metrics import confusion_matrix, mean_absolute_error
...
# 16-Fitting KNN  to the Training set
...
#----------------------------------------------------------------------------------------------
# 18-Creating the Confusion Matrix
from sklearn.metrics import confusion_matrix, mean_absolute_error
